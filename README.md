...
| `project-filter`   | comma-delimited string | Comma-delimited string used to filter eligible incentives by project type.<br> Valid values: `clothes_dryer`, `hvac`, `ev`, `solar`, `battery`, `water_heater`, `cooking`, `wiring`, `weatherization_and_efficiency`, `lawn_care` | none                                              |

...
export const templates = {
  ...
  s870d2cd66e4f1aa3: `Error al cargar los resultados.`,
  ...
  s5072405c9c4bc333: `The API key is invalid, or does not have enough permissions.`,
  ...
  sf69a7b006eeca1b8: `These results are based on your region, heating fuel(s), and selected upgrade, not the specific characteristics of your home.`,
  sca0e4c6a7c97a79c: `Graphical representation of the above numbers`,
  s7b4ae335fa702a88: str`\$${0} less`,
  se4592b2ecbb76b90: str`\$${0} more`,
  s3d54efd5ccda6c00: str`${0}lb less`,
  s58ce07d024786058: str`${0}lb more`,
  ...
  sdef4a548a26ce613: str`Our modeling shows that homes like yours will tend to have annual emissions reductions between ${0}lb and ${1}lb, with most homes reducing emissions by at least ${2}lb.`,
  s6df89e9986ae258d: str`Our modeling shows that homes like yours will tend to emit between ${0} and ${1} per year, with most homes reducing emissions by at least ${2}lb.`,
  s3b4030e1fd39d00f: str`Our modeling shows that homes like yours will tend to emit between ${0} and ${1} per year, with most homes increasing emissions by at least ${2}lb.`,
  ...
  s0c4ed3e9dde17304: `We cannot locate this address.`,
  s01c0b8cdfb47db52: `We are unable to estimate bill impacts for this address.`,
  sedd306baae77722d: `This calculator only supports residential addresses, and this address does not appear to be residential.`,
  se4ec75b1a54975ba: `This calculator only supports addresses in the United States.`,
  s6c87367cfdc80cc0: `This calculator does not support multifamily buildings, and this address appears to have multiple housing units.`,
  s84c0bea381be8b0e: `This calculator does not support addresses in Alaska or Hawaii.`,
  s133d52107175d759: `The calculator is temporarily unavailable. Please try again later.`,
  s8545c6dec16f5695: `An error occurred while calculating bill impacts.`,
  s2d9a3be29382aef0: `Enter your street address, city, state, and ZIP code.`,
  s5d916ed5ac60b831: `Enter your household information to see potential energy bill changes and emissions reductions by upgrade type.`,
  ...
  sffb6b8d1a387a7f5: `Heat pump (RI package)`,
  s8cc709b85da1eb49: `Heat pump (ducted, cold-climate package)`,
  s4887422d2a0398bd: `Heat pump (ductless, cold-climate package)`,
  sc9b08d464ea4775e: `A heat pump is a single appliance with two modes, heating and cooling. By transferring heat (instead of creating it), heat pumps use less energy, making them more efficient than traditional systems.`,
  ...
  s551164ee352060c7: `This is the ducted, cold-climate heat pump package currently used in our Colorado programs. SEER rating 17-19; COP@5°F: 2;`,
  s9c1ecf31424c575d: `This is the ductless, cold-climate heat pump package currently used in our Colorado programs. SEER rating: 18-21; COP@5°F of 1.8-2.`,
  s316484804a08a355: `Select upgrade`,
  se68a868c42bbd5bc: `Select an upgrade option to learn more about how it works within a household.`,

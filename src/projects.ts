...
const CLOTHES_DRYER_ICON = (color: string, w: number = 20, h: number = 20) =>
...
const COOKING_ICON = (color: string, w: number = 20, h: number = 20) =>
  svg`<svg width="${w}" height="${h}" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M1.25 4C1.25 2.48122 2.48122 1.25 4 1.25H16C17.5188 1.25 18.75 2.48122 18.75 4V16C18.75 17.5188 17.5188 18.75 16 18.75H4C2.48122 18.75 1.25 17.5188 1.25 16V4ZM4 2.75C3.30964 2.75 2.75 3.30964 2.75 4V16C2.75 16.6904 3.30964 17.25 4 17.25H16C16.6904 17.25 17.25 16.6904 17.25 16V4C17.25 3.30964 16.6904 2.75 16 2.75H4Z" fill="${color}"/>
...
const EV_ICON = (color: string, w: number = 20, h: number = 20) =>
  svg`<svg width="${w}" height="${h}" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const HVAC_ICON = (color: string, w: number = 20, h: number = 20) =>
  svg`<svg width="${w}" height="${h}" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const BATTERY_ICON = (color: string, w: number = 20, h: number = 20) =>
  svg`<svg width="${w}" height="${h}" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const SOLAR_ICON = (color: string, w: number = 20, h: number = 20) =>
  svg`<svg width="${w}" height="${h}" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const WATER_HEATER_ICON = (color: string, w: number = 20, h: number = 20) =>
  svg`<svg width="${w}" height="${h}" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
type ProjectInfo = {
  label: string;
  shortLabel?: string;
  icon: (color: string, w?: number, h?: number) => TemplateResult<2>;
  items: ItemType[];
};
